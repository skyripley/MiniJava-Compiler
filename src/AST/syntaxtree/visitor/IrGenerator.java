package AST.syntaxtree.visitor;
...
import AST.syntaxtree.visitor.ops.BinOp.Op;
import AST.syntaxtree.visitor.ops.ConditionalJump;
import AST.syntaxtree.visitor.ops.DataType;
...
import AST.symboltable.RamClass;
import AST.symboltable.RamMethod;
import AST.symboltable.RamVariable;
import AST.symboltable.Table;
import AST.syntaxtree.And;
import AST.syntaxtree.ArrayAssign;
import AST.syntaxtree.ArrayLength;
import AST.syntaxtree.ArrayLookup;
import AST.syntaxtree.Assign;
import AST.syntaxtree.Call;
import AST.syntaxtree.ClassDeclSimple;
import AST.syntaxtree.Equality;
import AST.syntaxtree.False;
import AST.syntaxtree.ForEach;
import AST.syntaxtree.Formal;
import AST.syntaxtree.IdentifierType;
import AST.syntaxtree.If;
import AST.syntaxtree.IntegerLiteral;
import AST.syntaxtree.LessThan;
import AST.syntaxtree.LessThanOrEqual;
import AST.syntaxtree.MainClass;
import AST.syntaxtree.MethodDecl;
import AST.syntaxtree.Minus;
import AST.syntaxtree.NewArray;
import AST.syntaxtree.NewObject;
import AST.syntaxtree.Not;
import AST.syntaxtree.Or;
import AST.syntaxtree.Plus;
import AST.syntaxtree.Print;
import AST.syntaxtree.PrintLn;
import AST.syntaxtree.This;
import AST.syntaxtree.Times;
import AST.syntaxtree.True;
import AST.syntaxtree.VarDecl;
import AST.syntaxtree.While;
...
public class IrGenerator extends DepthFirstVisitor
{
	...
	public void visit(MethodDecl d)
	{
		...
		for (AST.syntaxtree.Statement statement : d.sl)
		{
	...
	{
		currentOperand = new AST.syntaxtree.visitor.ops.IntegerLiteral(l.i);
	}
	...
	public void visit(NewArray a)
	{
		a.e.accept(this);
		Identifier dest = getNewTemporary(); 
		addStatement(new Assignment(new AST.syntaxtree.visitor.ops.ArrayAllocation(DataType.INT, currentOperand), dest));
		currentOperand = dest;
	}
	...
	public void visit(Call c)
	{
		...
		currentOperand = getNewTemporary();
		AST.syntaxtree.visitor.ops.Call call = new AST.syntaxtree.visitor.ops.Call(methodClassName, c.i.s, params);
	...
	public void visit(And a)
	{
		...
		addStatement(new ConditionalJump(new RelationalOp(RelationalOp.Op.EQ,
				currentOperand, new AST.syntaxtree.visitor.ops.IntegerLiteral(0)), falseLabel));
		a.e2.accept(this);
		addStatement(new ConditionalJump(new RelationalOp(RelationalOp.Op.EQ,
				currentOperand, new AST.syntaxtree.visitor.ops.IntegerLiteral(0)), falseLabel));
		addStatement(new Assignment(new AST.syntaxtree.visitor.ops.IntegerLiteral(1), result));
		addStatement(new Jump(endLabel));
		addStatement(falseLabel);
		addStatement(new Assignment(new AST.syntaxtree.visitor.ops.IntegerLiteral(0), result));
	...
	public void visit(Or a)
	{
		...
		// Short circuit - when expression 1 is "false", we do nothing further.
		addStatement(new ConditionalJump(new RelationalOp(RelationalOp.Op.EQ,
				currentOperand, new AST.syntaxtree.visitor.ops.IntegerLiteral(1)), trueLabel));
		a.e2.accept(this);
		addStatement(new ConditionalJump(new RelationalOp(RelationalOp.Op.EQ,
				currentOperand, new AST.syntaxtree.visitor.ops.IntegerLiteral(1)), trueLabel));
		addStatement(new Assignment(new AST.syntaxtree.visitor.ops.IntegerLiteral(0), result));
	...
	@Override
	public void visit(AST.syntaxtree.IdentifierExp e)
	{
	...
	@Override
	public void visit(AST.syntaxtree.Identifier e)
	{
	...
	{
		currentOperand = new AST.syntaxtree.visitor.ops.IntegerLiteral(0);
	}

	@Override
	public void visit(True t)
	{
		currentOperand = new AST.syntaxtree.visitor.ops.IntegerLiteral(1);
	}
	...
	public void visit(While n)
	{
		...
		n.e.accept(this);
		addStatement(new ConditionalJump(new RelationalOp(RelationalOp.Op.EQ,
				currentOperand, new AST.syntaxtree.visitor.ops.IntegerLiteral(0)), endLabel));
		n.s.accept(this);
	...
	public void visit(ArrayLength l)
	{
		super.visit(l);
		Identifier dest = getNewTemporary();		
		addStatement(new Assignment(new AST.syntaxtree.visitor.ops.ArrayLength(currentOperand), dest));
		currentOperand = dest;
	}
}
